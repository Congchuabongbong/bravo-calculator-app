...
export namespace ConcreteCommand {
	...
	class DividePercentCommand implements ICommand {
		private _calculator!: Calculator;
		private _value!: number;
		constructor(calculatorReceiver: Calculator, value: number) {
			this._calculator = calculatorReceiver;
	...
	exports = [AddCommand, DivideCommand, MultiplyCommand, DividePercentCommand, SubtractCommand, BackSpaceCommand, DecimalCommand, AbsoluteCommand];
}
